...
!function (a) {
    ...
    var d = [],
        e = function () {
            var b = !1;
            try { b = new a.XMLHttpRequest }
            catch (c) { b = new a.ActiveXObject("Microsoft.XMLHTTP") }
    ...
    if (c.ajax = f,
        ...
        var h, i, j, k = a.document,
            ...
            v = function (b) {
                var c = "clientWidth",
                    d = l[c], e = "CSS1Compat" === k.compatMode && d || k.body[c] || d,
                    f = {},
                    g = t[t.length - 1],
                    p = (new Date).getTime();
            ...
            w = function (a, b, d) {
                ...
                for (var j = 0; f > j; j++) {
                    var k, l, o, p;
                    i ? (k = d, n.push(h(a))) : (k = e[j].match(c.regex.findStyles) && RegExp.$1,
